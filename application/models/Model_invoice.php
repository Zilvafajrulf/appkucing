...
class Model_invoice extends CI_Model
{
	public function index()
	{
		...
		foreach ($this->cart->contents() as $item) {
			$data = array (
				'id_invoice' 	=> $order_id,
				'id_user' 		=> $id_user,
				'id_shelter' 		=>$item['options']['id_shelter'],
				'nama_shelter' 		=>$item['options']['nama_shelter'],
				'kota_shelter' 		=>$item['options']['kota_shelter'],
				'id_kucing' 		=> $item['id'],
				'jenis_kucing' 		=> $item['name'],
				'jumlah' 		=> $item['qty'],
				'biaya_adopsi' 		=> $item['price'],
			);
	...
	public function get($id_shelter)
	{
		$result = $this->db->where('id_shelter', $id_shelter)->get('transaction');
