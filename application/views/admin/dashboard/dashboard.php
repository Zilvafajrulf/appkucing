            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-6 -mb-6 intro-y">
                    <div class="alert alert-dismissible show box bg-primary text-white flex items-center mb-6" role="alert">
                        <span>Hallo selamat datang, <b><?= $this->session->userdata('nama_shelter') ?></b> Silahkan kelola dashboard kucing anda.</span>
                                ...
                                <div class="tab-pane active" id="active-users" role="tabpanel" aria-labelledby="active-users-tab">
                                    ...
                                    <div class="w-52 sm:w-auto mx-auto mt-5">
                                        <div class="flex items-center">
                                            ...
                                            <span class="truncate">ADOPSI BELUM DIBAYAR</span> <span class="font-medium ml-auto"><?= $pending; ?> Orders</span>
                                        </div>
                                        <div class="flex items-center mt-4">
                                            <div class="w-2 h-2 bg-success rounded-full mr-3"></div>
                                            <span class="truncate">ADOPSI SUDAH TERBAYAR</span> <span class="font-medium ml-auto"><?= $sukses; ?> Orders</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-8 mt-2 lg:mt-6 xl:mt-2">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">
                            Daftar Permintaan Adopsi Diterima
                        </h2>
                        <a href="" class="ml-auto text-primary truncate"></a>
                    </div>
                    <div class="mt-5">
