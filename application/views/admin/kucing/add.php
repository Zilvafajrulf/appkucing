<div class="content">
    ...
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-11 2xl:col-span-9">
            <form action="<?= site_url('admin/kucing/insert') ?>" method="post" enctype="multipart/form-data">
               ...
               <div class="intro-y box p-5">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-10">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-name" name="gambar1" type="file" class="form-control" placeholder="Product name">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-10">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-name" name="gambar2" type="file" class="form-control" placeholder="Product name">
                                    <div class="form-help text-right">Required for file types with type jpg, jpeg or png</div>
                                </div>
                            </div>
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-10">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-name" name="gambar3" type="file" class="form-control" placeholder="Product name">
                                    <div class="form-help text-right">Required for file types with type jpg, jpeg or png</div>
                                </div>
                            </div>
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-10">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-name" name="gambar4" type="file" class="form-control" placeholder="Product name">
                                    <div class="form-help text-right">Required for file types with type jpg, jpeg or png</div>
                                </div>
                            </div>
                            </div>
                    ...
                    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                        ...
                        <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Nama Shelter</div>
                                           
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                <?php foreach ($shelter as $id) : ?>
                                    <input type="text" class="form-control" id="nama_shelter" name="nama_shelter" value="<?= $id->nama_shelter ?>"autocomplete="off" readonly>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Kota Shelter</div>  
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                <?php foreach ($shelter as $id) : ?>
                                    <input type="text" class="form-control" id="kota_shelter" name="kota_shelter" value="<?= $id->kota_shelter ?>"autocomplete="off" readonly>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Jenis Kucing</div>
                                            <div class="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md">Required</div>
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="jenis_kucing" type="text" name="jenis_kucing" class="form-control" placeholder="Jenis Kucing">
                                    <?php foreach ($shelter as $id) : ?>
                                    <input type="hidden" name="id_shelter" value="<?= $id->id_shelter ?>">
                                    <?php endforeach; ?>
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Usia Kucing</div>
                                            <div class="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md">Required</div>
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="usia_kucing" type="text" name="usia_kucing" class="form-control" placeholder="Usia Kucing">
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Jenis Kelamin Kucing</div>
                                            <div class="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md">Required</div>
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="jk_kucing" type="text" name="jk_kucing" class="form-control" placeholder="Jenis Kelamin Kucing">
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Biaya Adopsi</div>
                                            <div class="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md">Required</div>
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="biaya_adopsi" type="text" name="biaya_adopsi" class="form-control" placeholder="Biaya Adopsi">
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                ...
                <div class="flex justify-end flex-col md:flex-row gap-2 mt-5">
                    <a href="<?= site_url('admin/kucing') ?>" class="btn py-3 border-slate-300 dark:border-darkmode-400 text-slate-500 w-full md:w-52">Cancel</a>
