                ...
                <div class="post__content tab-content">
                    <form id="payment-form" action="<?= site_url('dashboard/checkout_proccess') ?>" method="post">
                        ...
                        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                                <div class="font-medium flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5"> <i data-lucide="chevron-down" class="w-4 h-4 mr-2"></i> Shelter Information </div>
                                <?php foreach ($this->cart->contents() as $item) : ?>
                                <div class="mt-5">
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Nama Shelter <small class="text-danger">*</small></label>
                                        <input type="text" id="nama_shelter" name="nama_shelter" class="form-control" value="<?= $item['options']['nama_shelter']; ?>" autocomplete="off" readonly>
                                    </div>

                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Kota <small class="text-danger">*</small></label>
                                        <input type="text" id="kota_shelter" name="kota_shelter" class="form-control" value="<?= $item['options']['kota_shelter']; ?>" autocomplete="off" readonly>
                                    </div>
                            ...
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                ...
                                <div class="mt-5">
                                    <div class="mb-5">
                                       ...
                                       <?php foreach ($this->cart->contents() as $item) : ?>
                                            <input type="hidden" name="id_kucing" id="id_kucing" value="<?= $item['id']; ?>">
                                            <input type="hidden" name="id_shelter" id="id_shelter" value="<?= $item['options']['id_shelter']; ?>">
                                        <?php endforeach; ?>
                                   
                                        <!-- <input type="hidden" name="id_kucing" id="id_kucing" value="<?php echo $kucing->id_kucing ?>"> <?= $row->jenis_kucing?></td>-->
            ...
            <div id="ticket" class="tab-pane active" role="tabpanel" aria-labelledby="ticket-tab">
                <div class="box p-2 mt-5">
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        ...
                        <div class="ml-auto font-medium">6750527090 / Rumah Kucing Sejahtera</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">1918009817 / Rumah Kucing Sejahtera</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">6721598021 / Rumah Kucing Sejahtera</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
