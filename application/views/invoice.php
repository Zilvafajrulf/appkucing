        ...
        <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
            ...
            <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-10 pb-10 sm:pb-20">
                ...
                <div class="lg:text-right mt-10 lg:mt-0 lg:ml-auto">
                    ...
                    <div class="text-lg font-medium text-primary mt-2">Rumah Kucing Sejahtera</div>
                    <div class="mt-1">sejahterakucing@mail.co.id</div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        foreach ($pesanan as $row) :
                            $subtotal = $row->jumlah * $row->biaya_adopsi; 
                            $total += $subtotal; 
                            ?>
                            <tr>
                                <td class="!py-4">
                                    <div class="flex items-center">
                                        <a href="" class="font-medium whitespace-nowrap ml-4"><?= $row->jenis_kucing?></a> 
                                    </div>
                                </td>
                                <td class="text-right">Rp. <?= number_format($row->biaya_adopsi, 0, ',', '.') ?></td>
