                        ...
                        <?php foreach ($this->cart->contents() as $items) : ?>
                            <div class="cursor-pointer relative flex items-center ">
                                <div class="w-12 h-12 flex-none image-fit mr-1">
                                   <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?= base_url() . '/gambar_kucing/' . $items['options']['gambar1']; ?>">
                                ...
                                <div class="ml-2 overflow-hidden">
                                    ...
                                    <div class="w-full truncate text-slate-500 mt-0.5"><?php echo $items['options']['usia']; ?> </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        <br>
                ...
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('order') ?>" class="side-menu">
                            ...
                            <div class="side-menu__title"> Order History <div class="side-menu__sub-icon "></div>
                            </div>
                        </a>
                    </li>
                    <li>
