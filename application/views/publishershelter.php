                ...
                <div class="col-span-12 lg:col-span-12 mt-2">
                    <?php foreach ($shelter as $row) : ?>
                        <div class="box p-8 relative overflow-hidden intro-y">
                            <div class="text-primary dark:text-white text-xl -mt-3"><span class="font-medium">Hallo,</span> <?php echo $this->session->userdata('nama_shelter') ?></div>
                            ...
                            <a href="<?= site_url('publishershelter/activation/' . $row->id_shelter) ?>" class="btn w-32 bg-primary text-white mt-6 sm:mt-10">Aktivasi</a>
